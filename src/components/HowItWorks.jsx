        ...
        <div className='mt-10 md:mt-20 mb-14  ' >
          ...
          <div className='hiw-text-container' >
                <div className='flex flex-1 justify-center flex-col' >
                  <p className='hiw-text g_fadeIn' >A17 Pro is entirely new class of iphone chip that delivers our {' '} <span className='text-white' >
                    best graphic preformance by far 

                    </span>.
                     </p>

               
                <p className='hiw-text g_fadeIn' > Mobile {' '} <span className='text-white' >
